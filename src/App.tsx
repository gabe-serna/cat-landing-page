...
import { Droplets, Flower, Cross } from "lucide-react";

function App() {
  return (
    <div className="grid grid-rows-[3rem_auto] lg:grid-rows-[4rem_auto">
      <nav className="fixed z-50 flex items-center justify-between w-screen h-12 px-6 bg-white lg:h-16 lg:px-16">
      ...
      <div className="h-full row-span-1 row-start-2">
        <section
          id="hero"
          className="h-max lg:h-[90vh] p-6 flex flex-col gap-10 lg:flex-row lg:items-center lg:p-16"
        >
          <div>
        ...
        <section
          id="benefits"
          className="flex flex-col items-center gap-10 p-6 mt-24 h-max lg:h-screen lg:p-16"
        >
          ...
          <div className="flex flex-col-reverse items-center justify-around size-full lg:flex-row-reverse">
            <div className="flex-col w-full space-y-6 lg:w-1/3">
              <figure className="flex items-center w-full p-6 space-x-4 bg-white rounded-md h-min drop-shadow-lg">
                <Droplets className="opacity-75 text-amber-500 lg:min-w-10 lg:min-h-10 min-w-8 min-h-8" />
                <div>
                  <figcaption className="font-bold">Moisturizing</figcaption>
                  <p className="text-stone-400">
                    Feel your fur become more luscious with each passing day.
                  </p>
                </div>
              </figure>
              <figure className="flex items-center w-full p-6 space-x-4 bg-white rounded-md h-min drop-shadow-lg">
                <Flower className="opacity-75 text-amber-500 lg:min-w-10 lg:min-h-10 min-w-8 min-h-8" />
                <div>
                  <figcaption className="font-bold">Fragrant</figcaption>
                  <p className="text-stone-400">
                    Smell like a bed of roses, but without the thorns.
                  </p>
                </div>
              </figure>
              <figure className="flex items-center w-full p-6 space-x-4 bg-white rounded-md h-min drop-shadow-lg">
                <Cross className="opacity-75 text-amber-500 lg:min-w-10 lg:min-h-10 min-w-8 min-h-8" />
                <div>
                  <figcaption className="font-bold">Nourishing</figcaption>
                  <p className="text-stone-400">
                    Protect your fur from damage with a fortifying coat
                  </p>
                </div>
              </figure>
            </div>
            <img
              src="https://png.pngtree.com/png-clipart/20231115/original/pngtree-maine-coon-cat-pet-photo-png-image_13559084.png"
              className="lg:max-w-[40%] h-full p-0 m-0 aspect-auto grayscale"
            />
          </div>
        </section>
        <section
